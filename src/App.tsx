...
function App() {
	...
	const fetchUsers = async () => {
		try {
			const res = await fetch(
				"https://pgdemo.ntig.tech/api/api.php?action=users"
			);
	...
	const fetchProducts = async () => {
		try {
			const res = await fetch(
				"https://pgdemo.ntig.tech/api/api.php?action=products"
			);
			const data = await res.json();
			setProducts(data);
		} catch (error) {
	...
	const addUser = async () => {
		...
		try {
			await fetch("https://pgdemo.ntig.tech/api/api.php?action=users", {
				method: "POST",
	...
	const addPurchase = async () => {
		...
		try {
			const res = await fetch(
				"https://pgdemo.ntig.tech/api/api.php?action=purchases",
				{
					method: "POST",
					headers: { "Content-Type": "application/json" },
					body: JSON.stringify({
	...
	const fetchPurchaseDetails = async () => {
		try {
			const res = await fetch(
				"https://pgdemo.ntig.tech/api/api.php?action=purchasedetails"
			);
			const data = await res.json();
